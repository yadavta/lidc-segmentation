...
train_dataset = LIDCDataset2(train_img_path, mask_paths=train_mask_path, transforms=train_transforms, deeplab=True)
val_dataset = LIDCDataset2(val_img_path, mask_paths=val_mask_path, deeplab=True)
...
#     scaler=scaler,
    ...
    save_dir = 'runs/deeplabv3_resnet50_trivialaug_1',
    num_classes=2
)
