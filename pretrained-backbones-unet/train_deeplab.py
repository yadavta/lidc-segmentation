...
train_dataset = LIDCDataset(train_img_path, train_mask_path, transforms=train_transforms, deeplab=True)
val_dataset = LIDCDataset(val_img_path, val_mask_path, deeplab=True)
...
optimizer = torch.optim.Adam(params, 1e-3) # IOU 0.6348, 500 epochs, DICE loss
...
#     scaler=scaler,
    ...
    save_dir = 'runs/deeplabv3_resnet50_2',
    num_classes=2
)
