...
train_dataset = LIDCDataset(train_img_path, mask_paths=train_mask_path, transforms=train_transforms)
val_dataset = LIDCDataset(val_img_path, mask_paths=val_mask_path)
